package com.example.a_connect.student.studentCommunity
...
import com.example.a_connect.databinding.FragmentStudentCommunityBinding
import kotlinx.coroutines.flow.collectLatest
import kotlinx.coroutines.launch
import kotlin.getValue


class StudentCommunity : Fragment() {
    private lateinit var _binding: FragmentStudentCommunityBinding
    ...
    override fun onCreateView(
        ...
        _binding= FragmentStudentCommunityBinding.inflate(layoutInflater,container,false)
        return binding.root
    }
