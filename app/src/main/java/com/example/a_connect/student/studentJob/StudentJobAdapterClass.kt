...
class StudentJobAdapterClass  (private val onJobClick: (AlumniJobDataClass) -> Unit,
                         private val onApply: (AlumniJobDataClass) -> Unit
) : ListAdapter<AlumniJobDataClass,StudentJobAdapterClass.JobViewHolder>(JobDiffCallback()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StudentJobAdapterClass.JobViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.student_job_card, parent, false)
    ...
    override fun onBindViewHolder(holder: StudentJobAdapterClass.JobViewHolder, position: Int) {
